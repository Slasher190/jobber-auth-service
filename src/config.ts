...
class Config {
  ...
  public RABBITMQ_ENDPOINTS: string | undefined;
  public MYSQL_DB: string | undefined;
  public CLOUD_NAME: string | undefined;
  public CLOUD_API_KEY: string | undefined;
  public CLOUD_API_SECRET: string | undefined;
  public ELASTIC_SERACH_URL: string | undefined;
  ...
  constructor() {
    ...
    this.RABBITMQ_ENDPOINTS = process.env.RABBITMQ_ENDPOINTS || '';
    ...
    this.ELASTIC_SERACH_URL = process.env.ELASTIC_SERACH_URL || '';
